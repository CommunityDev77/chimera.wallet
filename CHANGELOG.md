...
- upgrades chimerawalletbackend for some transaction bugfixes
...
- bumps chimerawalletbackend version
...
- chimerawalletbackend-js version upgraded, now connects to daemon with KeepAlive = true
...
- bumps chimerawalletbackend-js dependency to latest version
...
- upgrade the chimerawalletbackend dependency to fix a bug that was caused by a batch of blocks in the ~200k range, also no longer checks for an update in development mode
